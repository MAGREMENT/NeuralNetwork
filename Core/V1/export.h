...
DLL_EXPORT void SetSchedulerConstant(neural_network* n);
DLL_EXPORT void SetSchedulerIterationDecay(neural_network* n, double proportion);
DLL_EXPORT void SetSchedulerExponentialDecay(neural_network* n, double decay);
DLL_EXPORT void SetSchedulerInverseDecay(neural_network* n, double decay);
